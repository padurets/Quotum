...
- **График недельных или пятичасовых окон** за 24 часа, 7 или 30 дней. Справа от
  «сейчас» видны план, куда идёт каждое окно при своём темпе и ближайшие сбросы,
  насколько далеко — выбираете вы; слева
...
- **Таблица с прогнозом:** сколько потрачено за период и, если тратить так же, как с
  ...
  оно закончится или сколько примерно останется. Прогноз одинаков на любом периоде. Для промежутка,
