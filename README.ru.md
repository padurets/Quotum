...
- **График недельных или пятичасовых окон** за последний час и дальше, до 30 дней.
  Справа от «сейчас» видны план и ближайшие сбросы, насколько далеко — выбираете вы;
  слева отмечено, когда лимиты вернулись досрочно и когда выдали бесплатные сбросы.
  Протяните по графику, чтобы приблизить всплеск работы (на телефоне сначала задержите
  палец); ‹ и › или свайп вбок листают его назад и вперёд на половину его длины.
- **Таблица с прогнозом:** сколько потрачено за период и, если тратить так же, хватит
  ли окна до сброса (или до конца плана) и сколько примерно останется. Для промежутка,
  выделенного на графике, — во что он обошёлся: сколько оставалось в начале и в конце,
  сколько потрачено и с каким темпом.
