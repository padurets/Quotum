...
- **Доска из виджетов** (карточка на каждую подписку, график, таблица), как дашборд в
  Grafana: карточки показывают, сколько осталось сейчас, а график и таблица под ними
  делят одни фильтры. Владелец доски перетаскивает их, делает шире или уже, называет карточки,
