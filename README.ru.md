...
- **Доступы остаются на месте.** Quotum никогда не читает, не хранит и не отправляет
  ...
  это отключают). Участникам доски их видно, только если человек, чьи это агенты,
  показывает эту подписку на доске. Полный список — в [спецификации](spec/ingest-v1.md#privacy).
