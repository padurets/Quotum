...
- **Таблица с прогнозом:** хватит ли окна при текущем темпе до сброса (или до конца
  плана) и сколько примерно останется.
- **Объявления о сбросах** из общественных трекеров [Codex Resets](https://codex-resets.com)
  ...
  выключить.
- **Доска из виджетов**: карточка на каждую подписку и график, как дашборд в Grafana.
