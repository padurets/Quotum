  ...
  return (
    <div className="connect">
      ...
      <section className="connect-way">
        ...
        <p>
          Для образов, виртуальных машин и контейнеров: пропишите токен один раз, и каждая запущенная машина сама появится на доске. Владелец —
          имя из <code>--owner</code>, иначе почта из Claude или Codex на машине, иначе создатель токена.
        </p>
        {created ? (
