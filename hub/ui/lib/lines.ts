 ...
 * cards show: a window the source no longer reports (its history outlives it) or one
 * hidden on the board is left out. A source's windows share its colour and differ by
 * dash.
 */
